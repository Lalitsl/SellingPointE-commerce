...
//	search all products by product Company names
	public List<Product> searchProductsByProductCompanyName(String productCompanyName){
		return productRepository.findAllByProductCompanyName(productCompanyName);
	}
